...
def get_l1d_satpy_scene(satobj: Union[Hypso1, Hypso2]) -> Scene:
...
# def generate_satpy_scene(satobj: Union[Hypso1, Hypso2], latitudes: np.ndarray, longitudes: np.ndarray) -> Scene:
...
# def _generate_satpy_scene(satobj: Union[Hypso1, Hypso2], latitudes: np.ndarray, longitudes: np.ndarray) -> Scene:

#     scene = Scene()

#     latitudes_xr, longitudes_xr = _generate_latlons(satobj=satobj)
...
def _generate_latlons(satobj: Union[Hypso1, Hypso2], latitudes: np.ndarray, longitudes: np.ndarray) -> tuple[xr.DataArray, xr.DataArray]:

    latitudes_xr = xr.DataArray(latitudes, dims=satobj.dim_names_2d)
    longitudes_xr = xr.DataArray(longitudes, dims=satobj.dim_names_2d)

    return latitudes_xr, longitudes_xr

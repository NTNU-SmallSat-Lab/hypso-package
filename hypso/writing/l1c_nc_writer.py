...
def l1c_nc_writer(satobj: Hypso, dst_l1c_nc_file: str, src_l1a_nc_file: str) -> None:
    """
    Create a l1c.nc file using the radiometrically and atmospherically corrected data. Same structure from the original l1a.nc file
    is used. 
    ...
    with (nc.Dataset(dst_l1c_nc_file, 'w', format='NETCDF4') as netfile):
        ...
        set_or_create_attr(netfile, attr_name="atmospheric_correction", attr_value=satobj.l1c_cube.attrs['correction'])
        ...
        try:
            ...
            print("[WARNING] Unable to write latitude and longitude information to NetCDF file. L1c may be incomplete. Please run georeferencing.")
        ...
        try:
            ...
            print("[WARNING] Unable to write navigation angles to NetCDF file. L1c file may be incomplete. Please run geometry computations.")
            print("[WARNING] Encountered exception: " + str(ex))

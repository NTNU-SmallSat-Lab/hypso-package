...
def load_l1d_nc(nc_file_path: Path) -> Tuple[dict, dict, dict, np.ndarray, dict]:

    nc_metadata_vars, nc_metadata_attrs, nc_global_metadata = load_l1d_nc_metadata(nc_file_path=nc_file_path)

    nc_cube = load_l1d_nc_cube(nc_file_path=nc_file_path)

    nc_cube_attrs = load_l1d_nc_cube_attrs(nc_file_path=nc_file_path)

    return nc_metadata_vars, nc_metadata_attrs, nc_global_metadata, nc_cube, nc_cube_attrs
...
def load_l1d_nc_metadata(nc_file_path: Path) -> Tuple[dict, dict, dict]:
    """

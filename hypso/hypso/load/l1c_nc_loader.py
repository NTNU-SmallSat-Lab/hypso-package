...
def load_l1c_nc(nc_file_path: Path) -> Tuple[dict, dict, dict, np.ndarray, dict]:

    nc_metadata_vars, nc_metadata_attrs, nc_global_metadata = load_l1c_nc_metadata(nc_file_path=nc_file_path)
...
def load_l1c_nc_metadata(nc_file_path: Path) -> Tuple[dict, dict, dict]:
    """

...
def load_l1b_nc(nc_file_path: Path, load_cube=True) -> Tuple[dict, dict, dict, dict, dict, dict, np.ndarray]:
...
def load_l1b_nc_metadata(nc_file_path: Path) -> Tuple[dict, dict]:
    """

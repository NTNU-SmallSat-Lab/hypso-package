...
h1_core_path = os.path.join(
    dir_path, "h1/lacrau_2024-12-26T10-24-27Z/lacrau_2024-12-26T10-24-27Z"
)

# HYPSO-2 Capture
h2_core_path = os.path.join(
    dir_path, "h2/lacrau_2024-12-26T11-15-54Z/lacrau_2024-12-26T11-15-54Z"
)
...
# Resample L1a cube
resampled_l1a_cube, resampled_latitudes, resampled_longitudes = resample_l1a_cube(
    satobj=satobj_h1, area_def=area_def, use_indirect_georef=True
)
...
resampled_l1a_cube_kdtree = resample_dataarray_kd_tree_nearest(
    area_def=area_def,
...
# Bilinear resampling
resampled_l1a_cube_bilinear = output = resample_dataarray_bilinear(
    area_def=area_def,
    data=satobj_h1.l1a_cube,
    latitudes=satobj_h1.latitudes,
    longitudes=satobj_h1.longitudes,
